...
public class ExceptionController {
    ...
    @ExceptionHandler(value = DatosGrupoMatriculaException.class)
    protected ResponseEntity<Map<String, Object>> handleFichaRoException(DatosGrupoMatriculaException e, HttpServletRequest request) {
